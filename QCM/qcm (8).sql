...
--
-- Hôte : 127.0.0.1:3307
-- Généré le : lun. 09 jan. 2023 à 09:59
...
(1, 1, 6, '2023-01-09 09:33:37'),
(2, 2, 6, '2023-01-09 09:34:39'),
(3, 1, 6, '2023-01-09 09:52:44'),
(4, 2, 6, '2023-01-09 10:01:06'),
(5, 2, 8, '2023-01-09 10:11:17'),
(6, 2, 2, '2023-01-09 10:32:03');
...
INSERT INTO `user` (`idu`, `pseudo`, `mdp`, `niveau`) VALUES
(1, 'admin', 'admin', 2),
(2, 'test', 'test', 1);
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `lastModif` datetime DEFAULT current_timestamp(),
  PRIMARY KEY (`idu`),
...
INSERT INTO `users` (`idu`, `pseudo`, `mdp`, `niveau`, `image`, `lastModif`) VALUES
(1, 'Prof', 'prof', 2, 'prof.jpg', '2022-03-16 11:36:15'),
(2, 'Eleve', 'eleve', 1, 'eleve.jpg', '2022-03-01 11:18:07'),
(3, 'Paul', 'paul', 1, 'paul.jpg', '2022-03-25 11:18:07'),
(4, 'Fred', 'fred', 1, 'fred.jpg', '2022-03-25 11:18:07'),
(5, 'Elise', 'elise', 1, 'elise.jpg', '2022-03-25 11:18:07'),
(6, 'Lune', 'lune', 2, 'lune.jpg', '2022-03-25 11:18:07');
